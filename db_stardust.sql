...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 13-Nov-2024 às 20:43
...
CREATE TABLE IF NOT EXISTS `tbl_jogos` (
  ...
  `categoria` enum('Ação/Aventura','Sobrevivência','RPG','Simulação','Esportes/Corrida','Terror/Suspense') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `preco` decimal(6,2) DEFAULT NULL,
  `slogan` varchar(150) DEFAULT NULL,
  `descricao` varchar(1500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
--
-- Extraindo dados da tabela `tbl_jogo_plataforma`
--
...
--
-- Estrutura da tabela `tbl_plataforma`
--
...
--
-- Extraindo dados da tabela `tbl_plataforma`
--
...
--
-- Estrutura da tabela `tbl_user_jogo`
--
...
--
-- Extraindo dados da tabela `tbl_user_jogo`
--
...
CREATE TABLE IF NOT EXISTS `tbl_usuarios` (
  ...
  `foto` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '../profilePhotos/photoPadrao.png',
...
--
-- Limitadores para a tabela `tbl_user_jogo`
--
