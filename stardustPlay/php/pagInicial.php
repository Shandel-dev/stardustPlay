...
<body>
    ...
    <section class="banner">
        <div class="banner_container">
            <a href="">
                <div class="banner_container_item"> <!--jogos-->
                    <img src="../imgs/controle_icon.svg" alt="">
                    <p>JOGOS</p>
                </div>
            </a>
            <a href="">
                <div class="banner_container_item"> <!--categorias-->
                    <img src="../imgs/categoria_icon.svg" alt="">
                    <p>CATEGORIAS</p>
                </div>
            </a>
            <a href="">
                <div class="banner_container_item"> <!--perfil-->
                    <img src="../imgs/perfil_icon.svg" alt="">
                    <p>PERFIL</p>
                </div>
            </a>
            <a href="">
                <div class="banner_container_item"> <!--desenvolvedor-->
